...
\begin{center}
\leavevmode
\includegraphics[width=343pt]{type_8h__incl}
\end{center}
\end{figure}
...
\item 
struct \hyperlink{structMosPair}{Mos\+Pair}
\begin{DoxyCompactList}\small\item\em A pair of id for \hyperlink{classInst}{Inst}. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Typedefs}
\begin{DoxyCompactItemize}
\item 
